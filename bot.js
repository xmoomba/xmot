...
function init() {
    ...
    $('.orderform-main.f-cb.marketOrder .f-fl:nth-child(1)').after(
        '<div id="xmot" class="f-fl" style="width:182px;padding:9px;border: 1px solid black">'
        + '<center>'
    ...
    $($('.marketOrder .orderforms-hd div').get(2)).after('<div class="xdel">'
        ...
        + '</span>'
        + '</div>');
   /* $('.marketOrder .f-fl .field.percent').after('<div id="buyReadonly" class="xdel" style="margin-left:63px">x</div>');*/
/*    $('.marketOrder .f-fr .field.percent').after('<div id="sellReadonly" class="xdel" style="margin-left:63px">y</div>');*/
